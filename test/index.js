    ...
    propertyConfig: { // config for property
        judge: {
            ...
            HCHR: [
                ...
                [   7, 0, 'UI_Judge_Level_4'],
                [   9, 0, 'UI_Judge_Level_5'],
                [  11, 0, 'UI_Judge_Level_6'],
            ],
            HMNY: [
                [0, 0, 'UI_Judge_Level_0'],
                [1, 0, 'UI_Judge_Level_1'],
            ...
            HSPR: [
                ...
                [   7, 0, 'UI_Spirit_Judge_Level_4'],
                [   9, 0, 'UI_Spirit_Judge_Level_5'],
                [  11, 0, 'UI_Spirit_Judge_Level_6'],
            ],
            HINT: [
                [0, 0, 'UI_Judge_Level_0'],
                [1, 0, 'UI_Judge_Level_1'],
            ...
            HAGE: [
                ...
                [  60, 0, 'UI_AGE_Judge_Level_5'],
                [  70, 0, 'UI_AGE_Judge_Level_6'],
                [  80, 0, 'UI_AGE_Judge_Level_7'],
                [  90, 0, 'UI_AGE_Judge_Level_8'],
                [  95, 0, 'UI_AGE_Judge_Level_9'],
                [ 100, 0, 'UI_AGE_Judge_Level_10'],
                [ 500, 0, 'UI_AGE_Judge_Level_11'],
            ],
            SUM: [
                [   0, 0, 'UI_Judge_Level_0'],
                ...
                [  80, 0, 'UI_Judge_Level_4'],
                [ 100, 0, 'UI_Judge_Level_5'],
                [ 110, 0, 'UI_Judge_Level_6'],
                [ 120, 0, 'UI_Judge_Level_7'],
            ],
        },
    },
